...
gmm_res=exp/tri3b_tr05_multi_noisy
gmm_ali=exp/tri3b_tr05_multi_noisy_ali
...
train_ivector_dir=exp/nnet3/ivectors_tr05_multi_noisy
...
if [ $stage -le 13 ]; then
  ...
  steps/align_fmllr_lats.sh --nj 30 --cmd "$train_cmd" ${lores_train_data_dir} \
