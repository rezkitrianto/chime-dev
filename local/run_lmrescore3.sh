...
srcdir=/home/rezki/sandbox/kaldi/egs/chime4DevFE1_allChannels3/s5_6ch/exp/chain/tdnn_blstm_1a_5layers_sp
...
dir=/home/rezki/sandbox/kaldi/egs/chime4DevFE1_allChannels3/s5_6ch/exp/chain/tdnn_blstm_1a_5layers_sp_lmrescore
...
if [ $stage -le 3 ]; then
  ...
  #       $dir/decode2_${t}_${enhan}_${lm_suffix}
  # done
  ...
  #     > $dir/best_wer_${enhan}_${lm_suffix}.result
  graphdir=/home/rezki/sandbox/kaldi/egs/chime4DevFE1_allChannels3/s5_6ch/exp/chain/tdnn_blstm_1a_5layers_sp/graph_sw1_tg
  local/chime4_calc_wers_fastblstm.sh $dir ${enhan}_${lm_suffix} $graphdir \
  #     > $dir/best_wer_${enhan}_${lm_suffix}.result
...
if [ $stage -le 4 ]; then
  ...
  #     data-fmllr-tri3b/${t}_$enhan \
  #     $dir/decode2_${t}_${enhan}_${lm_suffix} \
  #     $dir/decode2_${t}_${enhan}_${rnnlm_suffix}_w${rnnweight}_n${nbest}
  # done
  # exit 1
  ...
  #     > $dir/best_wer_${enhan}_${rnnlm_suffix}_w${rnnweight}_n${nbest}.result
    local/chime4_calc_wers_fastblstm.sh $dir ${enhan}_${rnnlm_suffix}_w${rnnweight}_n${nbest} $dir/graph_tgpr_5k \
        > $dir/best_wer_${enhan}_${rnnlm_suffix}_w${rnnweight}_n${nbest}.result
