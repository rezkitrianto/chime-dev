...
if [ ! -f $lang/L_align.fst ]; then
  ...
  local/make_L_align.sh data/local/lang_tmp $lang $lang 2>&1 | tee $dir/log/L_align.log
fi
...
$cmd $dir/log/align_to_words.log \
  ...
  phones-to-prons $lang/L_align.fst $wbegin $wend ark:- "ark,s:utils/sym2int.pl -f 2- --map-oov '$oov' $lang/words.txt <$data/text|" ark,t:$dir/rt2.txt \| \
...
local/txt_to_rttm.pl --symtab=$lang/words.txt $dir/align.txt $dir/rttm 2>$dir/log/rttm.log
