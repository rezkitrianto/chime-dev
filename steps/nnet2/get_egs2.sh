...
frames_per_eg=10   # number of frames of labels per example.  more->less disk space and
                  # less time preparing egs, but more I/O during training.
                  # note: the script may reduce this if reduce_frames_per_eg is true.
left_context=5    # amount of left-context per eg
right_context=5   # amount of right-context per eg
