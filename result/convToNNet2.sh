...
# Config:
stage=8 # resume training with --stage=N
flatstart=true
...
if [ $stage -le 8 ] && $flatstart; then
  steps/nnet2/convert_nnet1_to_nnet2.sh exp/tri4a_dnn_tr05_multi_noisy_smbr_i1lats exp/tri4a_dnn_tr05_multi_noisy_smbr_i1lats_nnet2
